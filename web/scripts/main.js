...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    _CryptoUtils_bytesToHex: function(bytes) {
      ...
      for (t1 = bytes.length, _i = 0; _i < bytes.length; bytes.length === t1 || (0, H.throwConcurrentModificationError)(bytes), ++_i) {
        ...
        t3 = t2.$lt(part, 16) ? "0" : "";
        result._contents += t3 + t2.toRadixString$1(part, 16);
      }
      t1 = result._contents;
    ...
    _AsyncRun__initializeScheduleImmediate_closure: {
      "^": "Closure:10;_async$_box_0,_captured_div_1,_captured_span_2",
    ...
    _Future__propagateToListeners_handleValueCallback: {
      "^": "Closure:5;_box_1,_captured_listener_3,_captured_sourceValue_4,_captured_zone_5",
      call$0: function() {
        var e, s, exception, t1;
        try {
    ...
    _Future__propagateToListeners_handleWhenCompleteCallback_closure0: {
      "^": "Closure:4;_async$_box_0,_captured_result_12",
      call$2: function(error, stackTrace) {
  ...
  }], ["dartcrypto.ciphers.affine", "package:dartcrypto/src/symmetric_key/stream_ciphers/affine.dart",, D, {
    "^": "",
    AffineCipher: {
      "^": "Object;key_A,key_B,modulo",
      checkKey$0: function() {
        var t1, gcd;
        t1 = this.modulo;
        if (t1 < 1)
          throw H.wrapException(B.PopUpError$("Alphabet size is " + t1 + "! It should be > 0!"));
        gcd = J.gcd$1$i(this.key_A, t1);
        if (gcd !== 1)
          throw H.wrapException(B.PopUpError$("GCD(key A, alphabet size) = GCD(" + H.S(this.key_A) + ", " + this.modulo + ") = " + gcd + " but should be = 1!"));
      },
      encrypt$1: function(message) {
        this.checkKey$0();
        return H.setRuntimeTypeInfo(new H.MappedListIterable(message, new D.AffineCipher_encrypt_closure(this)), [null, null]).toList$0(0);
      },
      decrypt$1: function(message) {
        this.checkKey$0();
        return H.setRuntimeTypeInfo(new H.MappedListIterable(message, new D.AffineCipher_decrypt_closure(this, J.modInverse$1$i(this.key_A, this.modulo))), [null, null]).toList$0(0);
      }
    },
    AffineCipher_encrypt_closure: {
      "^": "Closure:0;_affine$_captured_this_0",
      call$1: function(f) {
        var t1, t2;
        t1 = this._affine$_captured_this_0;
        t2 = J.$add$ns(J.$mul$ns(t1.key_A, f), t1.key_B);
        t1 = t1.modulo;
        if (typeof t2 !== "number")
          return t2.$mod();
        return C.JSNumber_methods.$mod(t2, t1);
      }
    },
    AffineCipher_decrypt_closure: {
      "^": "Closure:0;_affine$_captured_this_0,_captured_invKey_A_1",
      call$1: function(f) {
        var t1, t2;
        t1 = this._affine$_captured_this_0;
        t2 = J.$sub$n(f, t1.key_B);
        if (typeof t2 !== "number")
          return H.iae(t2);
        return C.JSNumber_methods.$mod(this._captured_invKey_A_1 * t2, t1.modulo);
      }
    }
  }], ["dartcrypto.ciphers.beaufort", "package:dartcrypto/src/symmetric_key/stream_ciphers/beaufort.dart",, G, {
    "^": "",
    BeaufortCipher: {
      "^": "Object;modulo,key",
      checkKey$0: function() {
        var t1 = this.key;
        if (t1.length === 0)
          throw H.wrapException(B.PopUpError$("Key is empty"));
        (t1 && C.JSArray_methods).forEach$1(t1, new G.BeaufortCipher_checkKey_closure(this));
      },
      encrypt$1: function(message) {
        var keySize, i, t1, t2;
        this.checkKey$0();
        ...
        for (i = 0; i < message.length; ++i) {
          t1 = this.key;
          t2 = C.JSInt_methods.$mod(i, keySize);
          if (t2 >= t1.length)
            return H.ioore(t1, t2);
          t2 = J.$sub$n(t1[t2], message[i]);
          t1 = this.modulo;
          if (typeof t2 !== "number")
            return t2.$mod();
          t1 = C.JSNumber_methods.$mod(t2, t1);
          if (i >= message.length)
    ...
    BeaufortCipher_checkKey_closure: {
      "^": "Closure:0;_beaufort$_captured_this_0",
      call$1: function(f) {
        var t1 = this._beaufort$_captured_this_0.modulo;
        if (typeof f !== "number")
          return f.$mod();
        return C.JSNumber_methods.$mod(f, t1);
      }
    }
  }], ["dartcrypto.ciphers.hill", "package:dartcrypto/src/symmetric_key/block_ciphers/hill.dart",, M, {
    "^": "",
    HillCipher: {
      "^": "Object;key,dimension,modulo",
      checkKey$0: function() {
        var t1, det;
        t1 = this.key;
        if (t1 == null || t1.isEmpty$0(0) === true)
          throw H.wrapException(B.PopUpError$("Key is null!"));
        t1 = this.dimension;
        H.checkNum(t1);
        H.checkNum(2);
        if (Math.pow(t1, 2) !== this.key.toList$0(0).length)
          throw H.wrapException(B.PopUpError$("Key is incorrect! Key length should be square but length is " + this.key.toList$0(0).length));
        det = this.key.determinant$0();
        t1 = J.getInterceptor(det);
        if (!t1.$eq(det, 0))
          if (t1.gcd$1(det, this.modulo) === 1) {
            C.JSInt_methods.modInverse$1(det, this.modulo);
            t1 = false;
          } else
            t1 = true;
        else
          t1 = true;
        if (t1)
          throw H.wrapException(B.PopUpError$("Key is incorrect! " + H.S(det) + " (Key determinant) shouldn't be 0 and coprime with " + this.modulo + "!"));
      },
      setKey$1: function(list) {
        var dim, t1;
        dim = C.JSNumber_methods.toInt$0(Math.ceil(Math.sqrt(H.checkNum(list.length))));
        this.dimension = dim;
        while (true) {
          t1 = list.length;
          if (!(t1 < Math.pow(dim, 2)))
            break;
          list.push(0);
        }
        this.key = A.Matrix$(dim, dim, list, this.modulo);
      },
      encrypt$1: function(message) {
        var t1, t2, encMessage, k, i, temp, j;
        this.checkKey$0();
        while (true) {
          t1 = message.length;
          t2 = this.dimension;
        ...
        encMessage = [];
        for (k = -1, i = 0; i < message.length; ++i) {
          t1 = this.dimension;
          if (typeof t1 !== "number")
            return H.iae(t1);
          ...
          while (true) {
            ...
            if (!(j < t1))
              break;
            t2 = this.key;
            t1 = C.JSInt_methods.$mod(i, t1);
            t2 = t2.matrix;
            if (t1 >= t2.length)
              return H.ioore(t2, t1);
            t1 = J.$index$asx(t2[t1], j);
            t2 = this.dimension;
            if (typeof t2 !== "number")
              return H.iae(t2);
            t2 = j + k * t2;
            if (t2 < 0 || t2 >= message.length)
              return H.ioore(message, t2);
            t2 = J.$mul$ns(t1, message[t2]);
            if (typeof t2 !== "number")
              return H.iae(t2);
            temp += t2;
            ++j;
          }
          encMessage.push(C.JSNumber_methods.$mod(temp, this.modulo));
        }
        return encMessage;
      },
      decrypt$1: function(message) {
        var t1, t2, invKey, decMessage, k, i, temp, j;
        this.checkKey$0();
        while (true) {
          t1 = message.length;
          t2 = this.dimension;
        ...
        for (k = -1, i = 0; i < message.length; ++i) {
          ...
          decMessage.push(C.JSNumber_methods.$mod(temp, this.modulo));
        }
        return decMessage;
      }
    }
  }], ["dartcrypto.ciphers.vernam", "package:dartcrypto/src/symmetric_key/stream_ciphers/vernam.dart",, E, {
    "^": "",
    VernamCipher: {
      "^": "Object;key,modulo",
      checkKey$1: function(key_length) {
        var t1 = this.key.length;
        if (t1 === 0)
          throw H.wrapException(B.PopUpError$("Key is empty"));
        if (t1 !== key_length)
          throw H.wrapException(B.PopUpError$("Key size is not equival to message size"));
      },
      encrypt$1: function(message) {
        var i, t1, t2;
        this.checkKey$1(message.length);
        for (i = 0; i < message.length; ++i) {
          t1 = message[i];
          t2 = this.key;
          if (i >= t2.length)
  ...
  }], ["dartcrypto.ciphers.vigenere", "package:dartcrypto/src/symmetric_key/stream_ciphers/vigenere.dart",, B, {
    "^": "",
    VigenereCipher: {
      "^": "Object;modulo,key",
      encrypt$1: function(message) {
        var keySize, i, t1, t2, t3;
        if (this.key.length === 0)
          H.throwExpression(B.PopUpError$("Key is empty"));
        keySize = this.key.length;
        for (i = 0; i < message.length; ++i) {
          t1 = message[i];
          t2 = this.key;
          t3 = C.JSInt_methods.$mod(i, keySize);
          if (t3 >= t2.length)
            return H.ioore(t2, t3);
          t3 = J.$add$ns(t1, t2[t3]);
          t2 = this.modulo;
          if (typeof t3 !== "number")
            return t3.$mod();
          t2 = C.JSNumber_methods.$mod(t3, t2);
          if (i >= message.length)
            return H.ioore(message, i);
          message[i] = t2;
        }
  ...
  }], ["dartcrypto.exceptions", "package:dartcrypto/src/exceptions.dart",, B, {
    "^": "",
    PopUpError: {
      "^": "Object;msg",
      toString$0: function(_) {
      ...
      PopUpError$1: function(keyValue) {
        if (keyValue === "")
          keyValue = "null";
        this.msg = keyValue;
        window.alert(keyValue);
      },
      static: {PopUpError$: function(keyValue) {
          var t1 = new B.PopUpError(null);
          t1.PopUpError$1(keyValue);
          return t1;
        }}
    }
  }], ["dartcrypto.utils.convert", "package:dartcrypto/src/utils/convert.dart",, O, {
    "^": "",
    hexStringToBytes: function(str) {
      var list, len, t1, i, t2, t3;
      list = [];
      len = J.get$length$asx(str);
      if (len !== C.JSNumber_methods.toInt$0(Math.floor(len / 2)) * 2)
        throw H.wrapException(B.PopUpError$("Cannot response hexadecimal number!"));
      for (t1 = str.length, i = 0; i < len; i += 2) {
        if (i >= t1)
        ...
        list.push(H.Primitives_parseInt(t2 + str[t3], 16, new O.hexStringToBytes_closure()));
      }
      return list;
    },
    hexStringToBytes_closure: {
      "^": "Closure:0;",
      call$1: function(source) {
        return H.throwExpression(B.PopUpError$("Message should be hexadecimal"));
      }
    }
  }], ["dartcrypto.utils.matrix", "package:dartcrypto/src/utils/matrix.dart",, A, {
    "^": "",
    Matrix: {
      "^": "Object;rows,columns,modulo,matrix",
      $index: function(_, index) {
        var t1 = this.matrix;
        if (index >>> 0 !== index || index >= t1.length)
          return H.ioore(t1, index);
      ...
      $indexSet: function(_, index, value) {
        ...
        if (!J.$eq$(t1.get$length(value), this.columns))
          throw H.wrapException(P.ArgumentError$value(t1.get$length(value), "value.length", "Length of row cannot be > than column"));
        t2 = this.modulo;
        t2 = t2 != null && t2 !== 0;
        t3 = this.matrix;
        if (t2) {
          t1 = t1.map$1(value, new A.Matrix_operator$indexSet_closure(this));
          if (index >= t3.length)
      ...
      determinant$0: function() {
        var t1, t2, t3, determinant, i;
        t1 = this.matrix;
        if (0 >= t1.length)
          return H.ioore(t1, 0);
        if (J.$eq$(J.get$length$asx(t1[0]), 1)) {
          t1 = this.matrix;
          if (0 >= t1.length)
            return H.ioore(t1, 0);
          return J.$index$asx(t1[0], 0);
        }
        if (!this.isSquare$0())
          throw H.wrapException(P.Exception_Exception("Matrix is not square: " + this.rows + ", " + this.columns));
        if (this.columns === 2 && this.rows === 2) {
          t1 = this.matrix;
          if (0 >= t1.length)
            return H.ioore(t1, 0);
          t1 = J.$index$asx(t1[0], 0);
          t2 = this.matrix;
          if (1 >= t2.length)
            return H.ioore(t2, 1);
          t2 = J.$mul$ns(t1, J.$index$asx(t2[1], 1));
          t1 = this.matrix;
          if (0 >= t1.length)
            return H.ioore(t1, 0);
          ...
          if (1 >= t3.length)
            return H.ioore(t3, 1);
          determinant = J.$sub$n(t2, J.$mul$ns(t1, J.$index$asx(t3[1], 0)));
          t1 = this.modulo;
          if (t1 != null && t1 !== 0) {
            ...
            if (typeof t1 !== "number")
              return H.iae(t1);
            return C.JSNumber_methods.$mod(determinant, t1);
          }
          return determinant;
        } else
          for (determinant = 0, i = 0; i < this.columns; ++i) {
            t1 = this.matrix;
            if (0 >= t1.length)
              return H.ioore(t1, 0);
            t1 = J.$index$asx(t1[0], i);
            t1 = J.$mul$ns(J.$mul$ns(t1, Math.pow(-1, 2 + i)), this.minor$2(0, i).determinant$0());
            if (typeof t1 !== "number")
              return H.iae(t1);
            determinant += t1;
          }
      ...
      inverse$0: function() {
        var det, t1, t2, detm, t3, t4, list, i, j, el;
        if (!this.isSquare$0())
          throw H.wrapException(P.Exception_Exception("Matrix is not square: " + this.rows + ", " + this.columns));
        det = this.determinant$0();
        t1 = J.getInterceptor(det);
        if (t1.$eq(det, 0))
          throw H.wrapException(P.ArgumentError$value(det, "det", "Matrix has determinant = 0. Cannot find inverse matrix"));
        t2 = this.modulo;
        if (t2 != null && t2 !== 0)
          detm = t1.modInverse$1(det, t2);
        else {
        ...
        t1 = this.rows;
        if (t1 === 1 && this.columns === 1)
          return A.Matrix$(1, 1, [detm], null);
        if (t1 === 2 && this.columns === 2) {
          t1 = this.matrix;
          if (1 >= t1.length)
            return H.ioore(t1, 1);
          t1 = J.$mul$ns(J.$index$asx(t1[1], 1), detm);
          t2 = this.matrix;
          if (0 >= t2.length)
            return H.ioore(t2, 0);
          t2 = J.$mul$ns(J.$mul$ns(J.$index$asx(t2[0], 1), detm), -1);
          t3 = this.matrix;
          if (1 >= t3.length)
            return H.ioore(t3, 1);
          t3 = J.$mul$ns(J.$mul$ns(J.$index$asx(t3[1], 0), detm), -1);
          t4 = this.matrix;
          if (0 >= t4.length)
            return H.ioore(t4, 0);
          list = [t1, t2, t3, J.$mul$ns(J.$index$asx(t4[0], 0), detm)];
          t1 = this.modulo;
          if (t1 != null && t1 !== 0)
            C.JSArray_methods.forEach$1(list, new A.Matrix_inverse_closure(this));
          return A.Matrix$(this.rows, this.columns, list, null);
        }
        list = [];
        for (i = 0; t1 = this.rows, i < t1; ++i)
          for (j = 0; j < this.columns; ++j) {
            t1 = Math.pow(-1, 1 + j + 1 + i);
            t2 = this.minor$2(i, j).determinant$0();
            if (typeof t2 !== "number")
              return H.iae(t2);
            el = detm * t1 * t2;
            t1 = this.modulo;
            if (t1 != null && t1 !== 0) {
              if (typeof t1 !== "number")
                return H.iae(t1);
              el = C.JSNumber_methods.$mod(el, t1);
            }
            list.push(el);
          }
        return A.Matrix$(t1, this.columns, list, null).transpose$0();
      },
      transpose$0: function() {
        ...
        for (i = 0; t1 = this.rows, i < t1; ++i)
          for (j = 0; j < this.columns; ++j) {
            ...
            if (j >= t1.length)
              return H.ioore(t1, j);
            list.push(J.$index$asx(t1[j], i));
          }
        return A.Matrix$(this.columns, t1, list, null);
      },
      isSquare$0: function() {
        var t1 = this.matrix;
        if (t1 == null || t1.length === 0)
      ...
      minor$2: function(i, j) {
        var list, k, t1, l, t2;
        list = [];
        for (k = 0; t1 = this.rows, k < t1; ++k)
          for (t1 = k !== i, l = 0; l < this.columns; ++l)
            if (t1 && j !== l) {
              t2 = this.matrix;
              if (k >= t2.length)
                return H.ioore(t2, k);
              list.push(J.$index$asx(t2[k], l));
            }
        return A.Matrix$(t1 - 1, this.columns - 1, list, null);
      },
      isEmpty$0: [function(_) {
        ...
        if (0 >= t2)
          return H.ioore(t1, 0);
        return J.get$isEmpty$asx(t1[0]);
      }, "call$0", "get$isEmpty", 0, 0, 5],
      toList$0: function(_) {
        var list, t1;
        list = [];
        t1 = this.matrix;
        (t1 && C.JSArray_methods).forEach$1(t1, new A.Matrix_toList_closure(list));
        return list;
      },
      toString$0: function(_) {
        return J.toString$0$(this.matrix);
      },
      Matrix$4: function(rows, columns, list, modulo) {
        var t1, i, t2, j, t3, t4, t5, t6;
        this.rows = rows;
          ...
          for (t2 = i * rows, j = 0; j < columns; ++j) {
            ...
            if (t3) {
              ...
              if (typeof modulo !== "number")
                return H.iae(modulo);
              J.add$1$ax(t3, C.JSNumber_methods.$mod(t4, modulo));
            } else {
              if (i >= t5.length)
                return H.ioore(t5, i);
              t3 = t5[i];
              if (t4 < 0 || t4 >= t6)
                return H.ioore(list, t4);
              J.add$1$ax(t3, list[t4]);
            }
          }
        }
      },
      static: {Matrix$: function(rows, columns, list, modulo) {
          var t1 = new A.Matrix(null, null, null, null);
          t1.Matrix$4(rows, columns, list, modulo);
          return t1;
        }}
    },
    Matrix_operator$indexSet_closure: {
      "^": "Closure:0;_matrix$_captured_this_0",
      call$1: function(f) {
        var t1 = this._matrix$_captured_this_0.modulo;
        if (typeof f !== "number")
          return f.$mod();
        if (typeof t1 !== "number")
          return H.iae(t1);
    ...
    Matrix_toList_closure: {
      "^": "Closure:0;_captured_list_0",
      call$1: function(f) {
        return J.forEach$1$ax(f, new A.Matrix_toList__closure(this._captured_list_0));
      }
    },
    Matrix_toList__closure: {
      "^": "Closure:0;_captured_list_1",
      call$1: function(g) {
        return this._captured_list_1.push(g);
      }
    }
    ...
    main: [function() {
      var cryptosystem, t1;
      cryptosystem = document.querySelector("#SelectCrypto");
      t1 = J.get$onChange$x(cryptosystem);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure(cryptosystem)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    }, "call$0", "main__main$closure", 0, 0, 2],
    buildStructure: function(cryptosystem) {
      var inputTextArea, keyTextArea, outputTextArea, encryptButton, decryptButton, descriptionParagraph, t1, t2, cipher;
      if (cryptosystem == null)
        throw H.wrapException(B.PopUpError$("Select Cryptosystem!"));
      inputTextArea = document.querySelector("#inputTextArea");
      keyTextArea = document.querySelector("#keyTextArea");
      ...
      descriptionParagraph = document.querySelector("#description");
      t1 = $.streamEncrypt;
      if (t1 != null)
        t1.cancel$0();
      t1 = $.streamDecrypt;
      ...
      if (t1 != null)
        t1.cancel$0();
      t1 = J.getInterceptor$x(descriptionParagraph);
      t1.get$children(descriptionParagraph).clear$0(0);
      t2 = descriptionParagraph.style;
      t2.display = "block";
      switch (cryptosystem) {
        case 0:
          t1.insertAdjacentHtml$4$treeSanitizer$validator(descriptionParagraph, "beforeend", "In cryptography, a <a href=\"https://en.wikipedia.org/wiki/Caesar_cipher\" target=\"_blank\">Caesar cipher</a>, also known as Caesar's cipher, the shift cipher, Caesar's code or Caesar shift, is one of the simplest and most widely known encryption techniques. It is a type of substitution cipher in which each letter in the plaintext is replaced by a letter some fixed number of positions down the alphabet. For example, with a left shift of 3, D would be replaced by A, E would become B, and so on. The method is named after Julius Caesar, who used it in his private correspondence.", null, null);
          cipher = new D.AffineCipher(1, 0, 256);
          t1 = J.getInterceptor$x(keyTextArea);
          t2 = t1.get$onChange(keyTextArea);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure(keyTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamKeyChange = t2;
          t2 = J.get$onClick$x(encryptButton);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure0(inputTextArea, keyTextArea, outputTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamEncrypt = t2;
          t2 = J.get$onClick$x(decryptButton);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure1(inputTextArea, keyTextArea, outputTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamDecrypt = t2;
          if (O.hexStringToBytes(t1.get$value(keyTextArea)).length === 1) {
            t1 = O.hexStringToBytes(t1.get$value(keyTextArea));
            if (0 >= t1.length)
              return H.ioore(t1, 0);
            cipher.key_B = t1[0];
          } else
            t1.set$value(keyTextArea, "00");
          break;
        case 1:
          t1.insertAdjacentHtml$4$treeSanitizer$validator(descriptionParagraph, "beforeend", "", null, null);
          cipher = new D.AffineCipher(1, 0, 256);
          t1 = J.getInterceptor$x(keyTextArea);
          t2 = t1.get$onChange(keyTextArea);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure2(keyTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamKeyChange = t2;
          t2 = J.get$onClick$x(encryptButton);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure3(inputTextArea, keyTextArea, outputTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamEncrypt = t2;
          t2 = J.get$onClick$x(decryptButton);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure4(inputTextArea, keyTextArea, outputTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamDecrypt = t2;
          if (O.hexStringToBytes(t1.get$value(keyTextArea)).length === 2) {
            t2 = O.hexStringToBytes(t1.get$value(keyTextArea));
            if (0 >= t2.length)
              return H.ioore(t2, 0);
            cipher.key_A = t2[0];
            t1 = O.hexStringToBytes(t1.get$value(keyTextArea));
            ...
            t1.set$value(keyTextArea, "0100");
          break;
        case 2:
          t1.insertAdjacentHtml$4$treeSanitizer$validator(descriptionParagraph, "beforeend", "", null, null);
          A.Matrix$(1, 1, [1], null);
          cipher = new M.HillCipher(null, null, 256);
          t1 = J.getInterceptor$x(keyTextArea);
          t2 = t1.get$onChange(keyTextArea);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure5(keyTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamKeyChange = t2;
          t2 = J.get$onClick$x(encryptButton);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure6(inputTextArea, keyTextArea, outputTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamEncrypt = t2;
          t2 = J.get$onClick$x(decryptButton);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure7(inputTextArea, keyTextArea, outputTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamDecrypt = t2;
          cipher.setKey$1(O.hexStringToBytes(t1.get$value(keyTextArea)));
          t1.set$value(keyTextArea, M._CryptoUtils_bytesToHex(cipher.key.toList$0(0)));
          break;
        case 3:
          t1.insertAdjacentHtml$4$treeSanitizer$validator(descriptionParagraph, "beforeend", "", null, null);
          cipher = new B.VigenereCipher(256, null);
          t1 = J.getInterceptor$x(keyTextArea);
          t2 = t1.get$onChange(keyTextArea);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure8(keyTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamKeyChange = t2;
          t2 = J.get$onClick$x(encryptButton);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure9(inputTextArea, keyTextArea, outputTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamEncrypt = t2;
          t2 = J.get$onClick$x(decryptButton);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure10(inputTextArea, keyTextArea, outputTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamDecrypt = t2;
          cipher.key = O.hexStringToBytes(t1.get$value(keyTextArea));
          break;
        case 4:
          t1.insertAdjacentHtml$4$treeSanitizer$validator(descriptionParagraph, "beforeend", "", null, null);
          cipher = new G.BeaufortCipher(256, null);
          t1 = J.getInterceptor$x(keyTextArea);
          t2 = t1.get$onChange(keyTextArea);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure11(keyTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamKeyChange = t2;
          t2 = J.get$onClick$x(encryptButton);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure12(inputTextArea, keyTextArea, outputTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamEncrypt = t2;
          t2 = J.get$onClick$x(decryptButton);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure13(inputTextArea, keyTextArea, outputTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamDecrypt = t2;
          cipher.key = O.hexStringToBytes(t1.get$value(keyTextArea));
          break;
        case 5:
          t1.insertAdjacentHtml$4$treeSanitizer$validator(descriptionParagraph, "beforeend", "", null, null);
          cipher = new E.VernamCipher(null, 256);
          t1 = J.getInterceptor$x(keyTextArea);
          t2 = t1.get$onChange(keyTextArea);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure14(keyTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamKeyChange = t2;
          t2 = J.get$onClick$x(encryptButton);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure15(inputTextArea, keyTextArea, outputTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamEncrypt = t2;
          t2 = J.get$onClick$x(decryptButton);
          t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.buildStructure_closure16(inputTextArea, keyTextArea, outputTextArea, cipher)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
          t2._tryResume$0();
          $.streamDecrypt = t2;
          cipher.key = O.hexStringToBytes(t1.get$value(keyTextArea));
          break;
        ...
        case 101:
          ...
          break;
        default:
          descriptionParagraph.textContent = "UNKNOWN CIPHER";
          throw H.wrapException(B.PopUpError$("Unknown cipher!"));
      }
      F.smoothScrollingTo(encryptButton, 50000, 0);
    },
    smoothScrollingTo: function(element, duration, offset) {
      var t1, targetPosition, totalFrames, t2, currentPosition;
      t1 = {};
      targetPosition = C.JSNumber_methods.round$0(element.offsetTop);
      totalFrames = C.JSDouble_methods.round$0(duration / 16.666666666666668);
      t1._captured_currentFrame_0 = 0;
      t2 = window;
      currentPosition = "scrollY" in t2 ? C.JSNumber_methods.round$0(t2.scrollY) : C.JSNumber_methods.round$0(t2.document.documentElement.scrollTop);
      t1._captured_currentPosition_1 = currentPosition;
      C.Window_methods.get$animationFrame(window).then$1(new F.smoothScrollingTo_animation(t1, totalFrames, (targetPosition + offset - currentPosition) / totalFrames));
    },
    main_closure: {
      "^": "Closure:0;_captured_cryptosystem_0",
      call$1: function(e) {
        return F.buildStructure(H.Primitives_parseInt(J.get$value$x(this._captured_cryptosystem_0), null, null));
      }
    },
    buildStructure_closure: {
      "^": "Closure:0;_captured_keyTextArea_0,_captured_cipher_1",
      call$1: function(e) {
        var t1, t2;
        t1 = this._captured_keyTextArea_0;
        t2 = J.getInterceptor$x(t1);
        if (O.hexStringToBytes(t2.get$value(t1)).length === 1) {
          t1 = O.hexStringToBytes(t2.get$value(t1));
          if (0 >= t1.length)
            return H.ioore(t1, 0);
          this._captured_cipher_1.key_B = t1[0];
        } else
          throw H.wrapException(B.PopUpError$("Key size is not 1!"));
      }
    },
    buildStructure_closure0: {
      "^": "Closure:0;_captured_inputTextArea_2,_captured_keyTextArea_3,_captured_outputTextArea_4,_captured_cipher_5",
      call$1: function(e) {
        var t1 = this._captured_cipher_5;
        J.set$value$x(this._captured_outputTextArea_4, M._CryptoUtils_bytesToHex(t1.encrypt$1(O.hexStringToBytes(J.get$value$x(this._captured_inputTextArea_2)))));
        J.set$value$x(this._captured_keyTextArea_3, M._CryptoUtils_bytesToHex([t1.key_B]));
      }
    },
    buildStructure_closure1: {
      "^": "Closure:0;_captured_inputTextArea_6,_captured_keyTextArea_7,_captured_outputTextArea_8,_captured_cipher_9",
      call$1: function(e) {
        var t1 = this._captured_cipher_9;
        J.set$value$x(this._captured_inputTextArea_6, M._CryptoUtils_bytesToHex(t1.decrypt$1(O.hexStringToBytes(J.get$value$x(this._captured_outputTextArea_8)))));
        J.set$value$x(this._captured_keyTextArea_7, M._CryptoUtils_bytesToHex([t1.key_B]));
      }
    },
    buildStructure_closure2: {
      "^": "Closure:0;_captured_keyTextArea_10,_captured_cipher_11",
      call$1: function(e) {
        var t1, t2, t3, t4;
        t1 = this._captured_keyTextArea_10;
        t2 = J.getInterceptor$x(t1);
        if (O.hexStringToBytes(t2.get$value(t1)).length === 2) {
          t3 = this._captured_cipher_11;
          t4 = O.hexStringToBytes(t2.get$value(t1));
          if (0 >= t4.length)
            return H.ioore(t4, 0);
          t3.key_A = t4[0];
          t1 = O.hexStringToBytes(t2.get$value(t1));
          ...
          throw H.wrapException(B.PopUpError$("Key size is not 2!"));
      }
    },
    buildStructure_closure3: {
      "^": "Closure:0;_captured_inputTextArea_12,_captured_keyTextArea_13,_captured_outputTextArea_14,_captured_cipher_15",
      call$1: function(e) {
        var t1 = this._captured_cipher_15;
        J.set$value$x(this._captured_outputTextArea_14, M._CryptoUtils_bytesToHex(t1.encrypt$1(O.hexStringToBytes(J.get$value$x(this._captured_inputTextArea_12)))));
        J.set$value$x(this._captured_keyTextArea_13, M._CryptoUtils_bytesToHex([t1.key_A, t1.key_B]));
      }
    },
    buildStructure_closure4: {
      "^": "Closure:0;_captured_inputTextArea_16,_captured_keyTextArea_17,_captured_outputTextArea_18,_captured_cipher_19",
      call$1: function(e) {
        var t1 = this._captured_cipher_19;
        J.set$value$x(this._captured_inputTextArea_16, M._CryptoUtils_bytesToHex(t1.decrypt$1(O.hexStringToBytes(J.get$value$x(this._captured_outputTextArea_18)))));
        J.set$value$x(this._captured_keyTextArea_17, M._CryptoUtils_bytesToHex([t1.key_A, t1.key_B]));
      }
    },
    buildStructure_closure5: {
      "^": "Closure:0;_captured_keyTextArea_20,_captured_cipher_21",
      call$1: function(e) {
        var t1, t2, t3;
        t1 = this._captured_cipher_21;
        t2 = this._captured_keyTextArea_20;
        t3 = J.getInterceptor$x(t2);
        t1.setKey$1(O.hexStringToBytes(t3.get$value(t2)));
        t3.set$value(t2, M._CryptoUtils_bytesToHex(t1.key.toList$0(0)));
      }
    },
    buildStructure_closure6: {
      "^": "Closure:0;_captured_inputTextArea_22,_captured_keyTextArea_23,_captured_outputTextArea_24,_captured_cipher_25",
      call$1: function(e) {
        var t1 = this._captured_cipher_25;
        J.set$value$x(this._captured_outputTextArea_24, M._CryptoUtils_bytesToHex(t1.encrypt$1(O.hexStringToBytes(J.get$value$x(this._captured_inputTextArea_22)))));
        J.set$value$x(this._captured_keyTextArea_23, M._CryptoUtils_bytesToHex(t1.key.toList$0(0)));
      }
    },
    buildStructure_closure7: {
      "^": "Closure:0;_captured_inputTextArea_26,_captured_keyTextArea_27,_captured_outputTextArea_28,_captured_cipher_29",
      call$1: function(e) {
        var t1 = this._captured_cipher_29;
        J.set$value$x(this._captured_inputTextArea_26, M._CryptoUtils_bytesToHex(t1.decrypt$1(O.hexStringToBytes(J.get$value$x(this._captured_outputTextArea_28)))));
        J.set$value$x(this._captured_keyTextArea_27, M._CryptoUtils_bytesToHex(t1.key.toList$0(0)));
      }
    },
    buildStructure_closure8: {
      "^": "Closure:0;_captured_keyTextArea_30,_captured_cipher_31",
      call$1: function(e) {
        var t1 = O.hexStringToBytes(J.get$value$x(this._captured_keyTextArea_30));
        this._captured_cipher_31.key = t1;
        return t1;
      }
    },
    buildStructure_closure9: {
      "^": "Closure:0;_captured_inputTextArea_32,_captured_keyTextArea_33,_captured_outputTextArea_34,_captured_cipher_35",
      call$1: function(e) {
        var t1 = this._captured_cipher_35;
        J.set$value$x(this._captured_outputTextArea_34, M._CryptoUtils_bytesToHex(t1.encrypt$1(O.hexStringToBytes(J.get$value$x(this._captured_inputTextArea_32)))));
        J.set$value$x(this._captured_keyTextArea_33, M._CryptoUtils_bytesToHex(t1.key));
      }
    },
    buildStructure_closure10: {
      "^": "Closure:0;_captured_inputTextArea_36,_captured_keyTextArea_37,_captured_outputTextArea_38,_captured_cipher_39",
      call$1: function(e) {
        var t1 = this._captured_cipher_39;
        J.set$value$x(this._captured_inputTextArea_36, M._CryptoUtils_bytesToHex(t1.decrypt$1(O.hexStringToBytes(J.get$value$x(this._captured_outputTextArea_38)))));
        J.set$value$x(this._captured_keyTextArea_37, M._CryptoUtils_bytesToHex(t1.key));
      }
    },
    buildStructure_closure11: {
      "^": "Closure:0;_captured_keyTextArea_40,_captured_cipher_41",
      call$1: function(e) {
        var t1 = O.hexStringToBytes(J.get$value$x(this._captured_keyTextArea_40));
        this._captured_cipher_41.key = t1;
        return t1;
      }
    },
    buildStructure_closure12: {
      "^": "Closure:0;_captured_inputTextArea_42,_captured_keyTextArea_43,_captured_outputTextArea_44,_captured_cipher_45",
      call$1: function(e) {
        var t1 = this._captured_cipher_45;
        J.set$value$x(this._captured_outputTextArea_44, M._CryptoUtils_bytesToHex(t1.encrypt$1(O.hexStringToBytes(J.get$value$x(this._captured_inputTextArea_42)))));
        J.set$value$x(this._captured_keyTextArea_43, M._CryptoUtils_bytesToHex(t1.key));
      }
    },
    buildStructure_closure13: {
      "^": "Closure:0;_captured_inputTextArea_46,_captured_keyTextArea_47,_captured_outputTextArea_48,_captured_cipher_49",
      call$1: function(e) {
        var t1 = this._captured_cipher_49;
        J.set$value$x(this._captured_inputTextArea_46, M._CryptoUtils_bytesToHex(t1.decrypt$1(O.hexStringToBytes(J.get$value$x(this._captured_outputTextArea_48)))));
        J.set$value$x(this._captured_keyTextArea_47, M._CryptoUtils_bytesToHex(t1.key));
      }
    },
    buildStructure_closure14: {
      "^": "Closure:0;_captured_keyTextArea_50,_captured_cipher_51",
      call$1: function(e) {
        var t1 = O.hexStringToBytes(J.get$value$x(this._captured_keyTextArea_50));
        this._captured_cipher_51.key = t1;
        return t1;
      }
    },
    buildStructure_closure15: {
      "^": "Closure:0;_captured_inputTextArea_52,_captured_keyTextArea_53,_captured_outputTextArea_54,_captured_cipher_55",
      call$1: function(e) {
        var t1 = this._captured_cipher_55;
        J.set$value$x(this._captured_outputTextArea_54, M._CryptoUtils_bytesToHex(t1.encrypt$1(O.hexStringToBytes(J.get$value$x(this._captured_inputTextArea_52)))));
        J.set$value$x(this._captured_keyTextArea_53, M._CryptoUtils_bytesToHex(t1.key));
      }
    },
    buildStructure_closure16: {
      "^": "Closure:0;_captured_inputTextArea_56,_captured_keyTextArea_57,_captured_outputTextArea_58,_captured_cipher_59",
      call$1: function(e) {
        var t1 = this._captured_cipher_59;
        J.set$value$x(this._captured_inputTextArea_56, M._CryptoUtils_bytesToHex(t1.decrypt$1(O.hexStringToBytes(J.get$value$x(this._captured_outputTextArea_58)))));
        J.set$value$x(this._captured_keyTextArea_57, M._CryptoUtils_bytesToHex(t1.key));
      }
    },
    smoothScrollingTo_animation: {
      "^": "Closure:17;_box_0,_captured_totalFrames_1,_captured_distancePerFrame_2",
      call$1: function(frame) {
        var t1, t2, t3, line;
        for (t1 = this._captured_totalFrames_1, t2 = this._box_0, t3 = this._captured_distancePerFrame_2; t1 >= t2._captured_currentFrame_0;) {
          C.Window_methods.scrollTo$2(window, 0, t2._captured_currentPosition_1);
          t2._captured_currentPosition_1 += t3;
          ++t2._captured_currentFrame_0;
          C.Window_methods.get$animationFrame(window).then$1(this);
          line = C.JSNumber_methods.toString$0(t2._captured_currentPosition_1);
          H.printString(line);
        }
      }
    }
  ...
  J.gcd$1$i = function(receiver, a0) {
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, void: true}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.bool}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [, P.StackTrace]}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, args: [P.Symbol,,]}, {func: 1, void: true, args: [W.Node, W.Node]}, {func: 1, void: true, args: [P.num]}];
